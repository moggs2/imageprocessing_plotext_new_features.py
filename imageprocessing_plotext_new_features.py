...
#
#  tf.keras.layers.Conv2D(filters=32, kernel_size=(4,4), strides=1, padding='valid', activation='relu'),
#  tf.keras.layers.MaxPooling2D(pool_size=(3,3)),
#  tf.keras.layers.Conv2D(filters=32, kernel_size=(4,4), strides=1, padding='valid', activation='relu'),
#  tf.keras.layers.MaxPooling2D(pool_size=(3,3)),
#  tf.keras.layers.Flatten(),
#  tf.keras.layers.Dense(64, activation='relu'),
#  #itf.keras.layers.Dense(total_imagefolders, activation='softmax')
...
learningratecallbackchange=tf.keras.callbacks.LearningRateScheduler(lambda epoch: 0.001 * 1.005 ** epoch)
